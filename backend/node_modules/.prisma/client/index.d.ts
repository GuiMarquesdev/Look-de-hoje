...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "category" | "piece" | "storeSetting" | "user" | "adminCredentials" | "heroSetting"
  ...
  export type AggregateHeroSetting = {
    ...
    _avg: HeroSettingAvgAggregateOutputType | null
    _sum: HeroSettingSumAggregateOutputType | null
    _min: HeroSettingMinAggregateOutputType | null
    _max: HeroSettingMaxAggregateOutputType | null
  }

  export type HeroSettingAvgAggregateOutputType = {
    interval_ms: number | null
  }

  export type HeroSettingSumAggregateOutputType = {
    interval_ms: number | null
  }
  ...
  export type HeroSettingAvgAggregateInputType = {
    interval_ms?: true
  }

  export type HeroSettingSumAggregateInputType = {
    interval_ms?: true
  }
  ...
  export type HeroSettingAggregateArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    **/
     ...
     * Select which fields to average
    **/
    _avg?: HeroSettingAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    _sum?: HeroSettingSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
  ...
  export type HeroSettingOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "slides" | "title" | "subtitle" | "cta_text" | "cta_link" | "background_image_url" | "created_at" | "updated_at" | "is_active" | "interval_ms", ExtArgs["result"]["heroSetting"]>
  ...
  interface HeroSettingFieldRefs {
    ...
    readonly subtitle: FieldRef<"HeroSetting", 'String'>
    readonly cta_text: FieldRef<"HeroSetting", 'String'>
    readonly cta_link: FieldRef<"HeroSetting", 'String'>
    readonly background_image_url: FieldRef<"HeroSetting", 'String'>
    readonly created_at: FieldRef<"HeroSetting", 'DateTime'>
    readonly updated_at: FieldRef<"HeroSetting", 'DateTime'>
    readonly is_active: FieldRef<"HeroSetting", 'Boolean'>
    readonly interval_ms: FieldRef<"HeroSetting", 'Int'>
  }
  ...
  export type HeroSettingWhereInput = {
    ...
    title?: StringNullableFilter<"HeroSetting"> | string | null
    subtitle?: StringNullableFilter<"HeroSetting"> | string | null
    cta_text?: StringNullableFilter<"HeroSetting"> | string | null
    cta_link?: StringNullableFilter<"HeroSetting"> | string | null
    background_image_url?: StringNullableFilter<"HeroSetting"> | string | null
    created_at?: DateTimeFilter<"HeroSetting"> | Date | string
    updated_at?: DateTimeFilter<"HeroSetting"> | Date | string
    is_active?: BoolFilter<"HeroSetting"> | boolean
    interval_ms?: IntFilter<"HeroSetting"> | number
  }
  ...
  export type HeroSettingOrderByWithAggregationInput = {
    ...
    _avg?: HeroSettingAvgOrderByAggregateInput
    _max?: HeroSettingMaxOrderByAggregateInput
    _min?: HeroSettingMinOrderByAggregateInput
    _sum?: HeroSettingSumOrderByAggregateInput
  }
  ...
  export type HeroSettingScalarWhereWithAggregatesInput = {
    ...
    title?: StringNullableWithAggregatesFilter<"HeroSetting"> | string | null
    subtitle?: StringNullableWithAggregatesFilter<"HeroSetting"> | string | null
    cta_text?: StringNullableWithAggregatesFilter<"HeroSetting"> | string | null
    cta_link?: StringNullableWithAggregatesFilter<"HeroSetting"> | string | null
    background_image_url?: StringNullableWithAggregatesFilter<"HeroSetting"> | string | null
    ...
    is_active?: BoolWithAggregatesFilter<"HeroSetting"> | boolean
    interval_ms?: IntWithAggregatesFilter<"HeroSetting"> | number
  }
  ...
  export type HeroSettingUpdateInput = {
    ...
    updated_at?: DateTimeFieldUpdateOperationsInput | Date | string
    is_active?: BoolFieldUpdateOperationsInput | boolean
    interval_ms?: IntFieldUpdateOperationsInput | number
  }
  ...
  export type HeroSettingAvgOrderByAggregateInput = {
    interval_ms?: SortOrder
  }
  ...
  export type HeroSettingSumOrderByAggregateInput = {
    interval_ms?: SortOrder
  }
